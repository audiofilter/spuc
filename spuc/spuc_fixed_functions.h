...
std::ostream &operator<<(
    std::ostream &os,
    const SPUC::spuc_fixed<NINT, NFRC, SPUC_Q_MODE, SPUC_O_MODE> &r) {
...
spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> operator>>(
    const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &a,
    const int &shift) {
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
          spuc_o_mode OMODE_>
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
          spuc_o_mode OMODE_>
bool operator==(const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE_, OMODE_> &b,
                const double &a) {
  return (b.to_double() == a);
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
...
// Compare with ints
template <int W, int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
          spuc_o_mode OMODE_>
bool operator==(const spuc_uint<W> &a,
                const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE_, OMODE_> &b) {
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
          spuc_o_mode OMODE_>
bool operator==(const uint64_t &a,
                const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE_, OMODE_> &b) {
  return (b.to_double() == double(a));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
double operator+(const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &b,
                 const double &a) {
  return (((double)a + (double)b));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
double operator-(const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &a,
                 const double &b) {
  return (((double)a - (double)b));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
double operator+(const uint64_t &a,
                 const spuc_fixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &b) {
  return (((double)a + (double)b));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
