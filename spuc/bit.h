...
class bit {
 ...
 public:
  ...
  inline bit& operator=(const short &value) {    b = (char)value; return *this; }
  inline bit& operator=(const bit &x)   { b=x.b; return *this; }
  inline bit& operator/=(const bit &x) { b=b|x.b; return *this; }
  inline bit& operator|=(const bit &x) { b=b|x.b; return *this; }
  inline bit& operator+=(const bit &x) { b=b^x.b; return *this; }
  inline bit& operator^=(const bit &x) { b=b^x.b; return *this; }
  inline bit& operator-=(const bit &x) { b=b^x.b; return *this; }
