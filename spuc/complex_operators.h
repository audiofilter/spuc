...
COMPLEX_SINGOP(int_s,int_s,int_s)
COMPLEX_SINGOP(vfixed,vfixed,vfixed)
COMPLEX_SINGOP(vfloat,vfloat,vfloat)
COMPLEX_SINGOP(vlog,vlog,vlog)
COMPLEX_SINGOP(fxd,fxd,fxd)
...
COMPLEX_MULTOP(float,int_s,float)
COMPLEX_MULTOP(float,vfixed,float)
COMPLEX_MULTOP(float,vfloat,float)
COMPLEX_MULTOP(float,vlog,float)
COMPLEX_MULTOP(float,fxd,float)

COMPLEX_MULTOP(long,fxd,long)
COMPLEX_MULTOP(long,vlog,long)
COMPLEX_MULTOP(long,vfloat,long)
COMPLEX_MULTOP(long,vfixed,long)
COMPLEX_MULTOP(long,int_s,long)
COMPLEX_MULTOP(long,int,long)

COMPLEX_MULTOP(int,int_s,int)
COMPLEX_MULTOP(int,vfixed,vfixed)
COMPLEX_MULTOP(int,vfloat,vfloat)
COMPLEX_MULTOP(int,vlog,vlog)
COMPLEX_MULTOP(int,fxd,fxd)

COMPLEX_MULTOP(double,long,double)
COMPLEX_MULTOP(double,int_s,double)
COMPLEX_MULTOP(double,int,double)
COMPLEX_MULTOP(double,vfixed,double)
COMPLEX_MULTOP(double,vfloat,double)
COMPLEX_MULTOP(double,vlog,double)
COMPLEX_MULTOP(double,fxd,double)
...
COMPLEX_MULTOP(int_s,Double,double)
COMPLEX_MULTOP(vfixed,Double,double)
COMPLEX_MULTOP(vfloat,Double,double)
COMPLEX_MULTOP(vlog,Double,double)
COMPLEX_MULTOP(fxd,Double,double)

COMPLEX_MULTOP(double,Float,double)
COMPLEX_MULTOP(float,Float,float)
COMPLEX_MULTOP(long,Float,float)
COMPLEX_MULTOP(int,Float,float)
COMPLEX_MULTOP(int_s,Float,float)
COMPLEX_MULTOP(vfixed,Float,float)
COMPLEX_MULTOP(vfloat,Float,float)
COMPLEX_MULTOP(vlog,Float,float)
COMPLEX_MULTOP(fxd,Float,float)

COMPLEX_MULTOP(double,Long,double)
COMPLEX_MULTOP(float,Long,double)
COMPLEX_MULTOP(long,Long,long)
COMPLEX_MULTOP(int,Long,long)
COMPLEX_MULTOP(int_s,Long,long)
COMPLEX_MULTOP(vfixed,Long,long)
COMPLEX_MULTOP(vfloat,Long,long)
COMPLEX_MULTOP(vlog,Long,long)
COMPLEX_MULTOP(fxd,Long,long)

COMPLEX_MULTOP(double,Int,double)
COMPLEX_MULTOP(float,Int,float)
COMPLEX_MULTOP(long,Int,long)
COMPLEX_MULTOP(int,Int,int)
COMPLEX_MULTOP(int_s,Int,int)
COMPLEX_MULTOP(vfixed,Int,int)
COMPLEX_MULTOP(vfloat,Int,int)
COMPLEX_MULTOP(vlog,Int,int)
COMPLEX_MULTOP(fxd,Int,int)
