...
class spuc_fixed {
 ...
 public:
  ...
  /// built-in types
  template <int W> spuc_fixed(const spuc_int<W> &a) { from_int(a.to_int()); }
  template <int W> spuc_fixed(const spuc_uint<W> &a) { from_uint(a.to_int()); }
  ...
  spuc_fixed(const spuc_fixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &a) {
  ...
  /// from spuc_ufixed<>
  template <int TOTAL_BITS_1, int INT_BITS_1, spuc_q_mode SPUC_Q_MODE_1, spuc_o_mode SPUC_O_MODE_1>
  spuc_fixed(const spuc_ufixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &a) {
    // Combine separate round and saturates
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(
        spuc_shift_class_function<TOTAL_BITS_ - INT_BITS_, SPUC_Q_MODE_>::shift_function(a));
  }
  ...
  spuc_fixed &operator++() {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(val + (1 << (TOTAL_BITS_ - INT_BITS_)));
    return *this;
  }
  ...
  template <int W_1> spuc_fixed<TOTAL_BITS_, INT_BITS_, SPUC_Q_MODE_, SPUC_O_MODE_> &operator=(const spuc_int<W_1> &a) {
    // saturates
  ...
  /// assignment operator from spuc_int
  template <int W_1>
  spuc_fixed<TOTAL_BITS_, INT_BITS_, SPUC_Q_MODE_, SPUC_O_MODE_> &operator=(const spuc_uint<W_1> &a) {
    // saturates
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(max_int_type(a.to_int()));
    return *this;
  }
  ...
  template <int TOTAL_BITS_1, int INT_BITS_1, spuc_q_mode SPUC_Q_MODE_1, spuc_o_mode SPUC_O_MODE_1>
  spuc_fixed &operator+=(const spuc_fixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &a) {
    spuc_fixed<Template_Max_Total_Bits<TOTAL_BITS_, INT_BITS_, TOTAL_BITS_1, INT_BITS_1>::maxval + 1,
               Template_Max<INT_BITS_, INT_BITS_1>::maxval + 1, SPUC_Q_MODE_1,
               SPUC_O_MODE_1> tmp(*this);  // just extra headroom above and below
    spuc_fixed<Template_Max_Total_Bits<TOTAL_BITS_, INT_BITS_, TOTAL_BITS_1, INT_BITS_1>::maxval + 1,
               Template_Max<INT_BITS_, INT_BITS_1>::maxval + 1, SPUC_Q_MODE_1,
  ...
  template <int TOTAL_BITS_1, int INT_BITS_1, spuc_q_mode SPUC_Q_MODE_1, spuc_o_mode SPUC_O_MODE_1>
  spuc_fixed &operator+=(const spuc_ufixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &a) {
    spuc_fixed<Template_Max_Total_Bits<TOTAL_BITS_, INT_BITS_, TOTAL_BITS_1, INT_BITS_1>::maxval + 2,
  ...
  template <int TOTAL_BITS_1, int INT_BITS_1, spuc_q_mode SPUC_Q_MODE_1, spuc_o_mode SPUC_O_MODE_1>
  spuc_fixed &operator*=(const spuc_fixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &b) {
    // first full precision
    spuc_fixed<(TOTAL_BITS_ + TOTAL_BITS_1), (INT_BITS_ + INT_BITS_1), SPUC_Q_MODE_, SPUC_O_MODE_> tmp = *this * b;
  ...
  template <int TOTAL_BITS_1, int INT_BITS_1, spuc_q_mode SPUC_Q_MODE_1, spuc_o_mode SPUC_O_MODE_1>
  spuc_fixed &operator*=(const spuc_ufixed<TOTAL_BITS_1, INT_BITS_1, SPUC_Q_MODE_1, SPUC_O_MODE_1> &b) {
    // first full precision
    spuc_fixed<(TOTAL_BITS_ + TOTAL_BITS_1), (INT_BITS_ + INT_BITS_1), SPUC_Q_MODE_, SPUC_O_MODE_> tmp = *this * b;
    // now assign from larger type
    *this = tmp;
  ...
  template <int TOTAL_BITS_1, int INT_BITS_1> spuc_fixed &operator/=(const spuc_fixed<TOTAL_BITS_1, INT_BITS_1> &b) {
  ...
  spuc_fixed &operator+=(const double &a) {
    spuc_fixed tmp(a);
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(val + tmp.getVal());
    return *this;
  }
  spuc_fixed &operator-=(const double &a) {
    spuc_fixed tmp(a);
  ...
  spuc_fixed &operator+=(const int8_t &a) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(val + (a << (TOTAL_BITS_ - INT_BITS_)));
    return *this;
  }
  spuc_fixed &operator-=(const int8_t &a) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(val - (a << (TOTAL_BITS_ - INT_BITS_)));
  ...
  spuc_fixed &operator*=(const int8_t &a) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(int64_t(floor(val * a + 0.5)));
    return *this;
  }
  spuc_fixed &operator/=(const int8_t &a) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(int64_t(floor(val / a + 0.5)));
  ...
  /// Left shifts + assign
  template <int W> spuc_fixed &operator<<=(spuc_int<W> shift) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate((max_val_type)val << shift.to_int());
    return *this;
  }
  template <int W> spuc_fixed &operator<<=(spuc_uint<W> shift) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate((max_val_type)val << shift.to_int());
    return *this;
  }
  ...
  spuc_fixed &operator<<=(int8_t shift) {
    val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate((max_val_type)val << shift);
    return *this;
  }
  ...
  void multm1() { val = -val; }
  void flip() { val = spuc_saturate_class_function<TOTAL_BITS_, SPUC_O_MODE_>::saturate(~val); }
