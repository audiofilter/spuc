...
spuc_int<Template_Max<W_, W_1 + 1>::maxval + 1>
...
template <int W_, int W_1>
spuc_int<Template_Max<W_ + 1, W_1>::maxval + 1>
...
// <<
template <int W_, int W_1>
spuc_int<W_ + (1 << W_1) - 1> operator<<(const spuc_int<W_> &a,
...
template <int W_, int W_1>
spuc_int<Template_Max<W_, W_1>::maxval> operator|(const spuc_int<W_> &a,
...
template <int W_, int W_1>
spuc_int<Template_Max<W_, W_1>::maxval> operator|(const spuc_uint<W_> &a,
...
template <int W_> bool operator==(const double &a, const spuc_int<W_> &b) {
...
template <int W_> bool operator==(const spuc_int<W_> &b, const double &a) {
  return (b.to_double() == a);
}
template <int W_> bool operator!=(const spuc_int<W_> &b, const double &a) {
  return (b.to_double() != a);
...
// compare with uint64
template <int W_> bool operator==(const uint64_t &a, const spuc_int<W_> &b) {
  return (b.to_int() == a);
}
template <int W_> bool operator!=(const uint64_t &a, const spuc_int<W_> &b) {
  return (b.to_int() != a);
...
template <int W_> bool operator==(const spuc_int<W_> &b, const uint64_t &a) {
  return (b.to_int() == a);
}
template <int W_> bool operator!=(const spuc_int<W_> &b, const uint64_t &a) {
  return (b.to_int() != a);
...
// compare with int64
template <int W_> bool operator==(const int &a, const spuc_int<W_> &b) {
  return (b.to_int() == a);
}
template <int W_> bool operator!=(const int &a, const spuc_int<W_> &b) {
  return (b.to_int() != a);
...
template <int W_> bool operator==(const spuc_int<W_> &b, const int &a) {
  return (b.to_int() == a);
}
template <int W_> bool operator!=(const spuc_int<W_> &b, const int &a) {
  return (b.to_int() != a);
...
// Math Ops
template <int W_> double operator+(const double &a, const spuc_int<W_> &b) {
  return (((double)a + (double)b));
}
template <int W_> double operator+(const spuc_int<W_> &b, const double &a) {
  return (((double)a + (double)b));
}
template <int W_> double operator-(const double &a, const spuc_int<W_> &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator-(const spuc_int<W_> &a, const double &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator*(const double &a, const spuc_int<W_> &b) {
  return (((double)a * (double)b));
...
template <int W_> double operator+(const int &a, const spuc_int<W_> &b) {
  return (((double)a + (double)b));
}
template <int W_> double operator+(const spuc_int<W_> &b, const int &a) {
  return (((double)a + (double)b));
}
template <int W_> double operator-(const int &a, const spuc_int<W_> &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator-(const spuc_int<W_> &a, const int &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator*(const int &a, const spuc_int<W_> &b) {
  return (((double)a * (double)b));
...
template <int W_> double operator+(const uint64_t &a, const spuc_int<W_> &b) {
  return (((double)a + (double)b));
}
template <int W_> double operator+(const spuc_int<W_> &b, const uint64_t &a) {
  return (((double)a + (double)b));
}
template <int W_> double operator-(const uint64_t &a, const spuc_int<W_> &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator-(const spuc_int<W_> &a, const uint64_t &b) {
  return (((double)a - (double)b));
}
template <int W_> double operator*(const uint64_t &a, const spuc_int<W_> &b) {
  return (((double)a * (double)b));
