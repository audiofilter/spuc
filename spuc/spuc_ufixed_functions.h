...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
          spuc_o_mode OMODE_>
bool operator==(const spuc_ufixed<TOTAL_BITS_, INT_BITS_, QMODE_, OMODE_> &b,
                const double &a) {
  return (b.to_double() == a);
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE_,
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
double operator+(const spuc_ufixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &b,
                 const double &a) {
  return (((double)a + (double)b));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
...
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
double operator-(const spuc_ufixed<TOTAL_BITS_, INT_BITS_, QMODE, OMODE> &a,
                 const double &b) {
  return (((double)a - (double)b));
}
template <int TOTAL_BITS_, int INT_BITS_, spuc_q_mode QMODE, spuc_o_mode OMODE>
