...
// Module ======================================================================
BOOST_PYTHON_MODULE(fir_float)
{
    class_< SPUC::fir<float,float> >("fir_float", init<  >())
        .def(init< const SPUC::fir<float,float>& >())
        ...
        .def("settap", (void (SPUC::fir<float,float>::*)(std::vector<float>) )&SPUC::fir<float,float>::settap)
    ;
