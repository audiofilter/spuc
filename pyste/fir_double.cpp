...
// Module ======================================================================
BOOST_PYTHON_MODULE(fir_double)
{
    class_< SPUC::fir<double,double> >("fir_double", init<  >())
        .def(init< const SPUC::fir<double,double>& >())
        .def(init< long int, optional< long int > >())
        .def(init< SPUC::fir_coeff<double> >())
        .def(init< const char* >())
        ...
        .def("settap", (void (SPUC::fir<double,double>::*)(SPUC::smart_array<double>) )&SPUC::fir<double,double>::settap)
    ;
